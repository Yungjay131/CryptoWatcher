package com.slyworks.cryptowatcher.location;
...
/**
 * Created by Joshua Sylvanus, 6:08 PM, 8/30/2020.
 */
public class LocationManager implements LifecycleObserver {
    //class to represent Location-related code and implement Lifecycle-Aware logic
    ...
    public LocationManager(Context con, Tracker mTracker) {
