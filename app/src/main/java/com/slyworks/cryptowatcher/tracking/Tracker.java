package com.slyworks.cryptowatcher.tracking;
...
/**
 * Created by Joshua Sylvanus, 8:29 AM, 27/08/2020.
 */

//to make this class LifeCycleAware
public class Tracker implements LifecycleObserver {
    ...
    public Tracker(Context con) {
        ...
        //part of making LifeCycleAware
        //next step would be to add appropriate Lifecycle annotations
        //eg @OnCreate
    ...
    public void trackOnDestroy() {
        ...
        //remember to remove observer from class
        ((AppCompatActivity)con).getLifecycle().removeObserver(this);

        //querying for current LifeCycle state
        Lifecycle.State currentState = ((AppCompatActivity)con).getLifecycle().getCurrentState();
    }
